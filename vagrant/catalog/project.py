...
from newmenuitem import NewMenuItemForm
app = Flask(__name__)
...
def restaurantMenuItemJSON(restaurant_id, menu_id):
    item = session.query(MenuItem).filter_by(id =
        menu_id).one()
...
def editMenuItem(restaurant_id, menu_id):
    ...
    if request.method == 'POST':
        ...
        ''' USE THE RENDER_TEMPLATE FUNCTION BELOW TO SEE THE
        VARIABLES YOU SHOULD USE IN YOUR EDITMENUITEM TEMPLATE'''
